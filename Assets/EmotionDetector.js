...
// @input float smoothingFactor = 0.35 {"hint": "Smoothing for score transitions (0=no smoothing, 1=instant)"}
// @input float hysteresis = 0.08 {"hint": "Extra threshold the current emotion gets to prevent flickering"}
...
script.createEvent("OnStartEvent").bind(function () {
    print("EmotionDetector: Initializing...");
